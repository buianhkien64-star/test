...
public class AshenBulletKin {
    ...
    public AshenBulletKin(Point position) {
        ...
        this.image = new Image("res/ashen_bullet_kin.png");
        this.health = Double.parseDouble(ShadowDungeon.getGameProps().getProperty("ashenBulletKinHealth"));
        this.shootFrequency = Integer.parseInt(ShadowDungeon.getGameProps().getProperty("ashenBulletKinShootFrequency"));
        this.coinValue = Integer.parseInt(ShadowDungeon.getGameProps().getProperty("ashenBulletKinCoin"));
    }
